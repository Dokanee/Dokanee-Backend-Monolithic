    ...
    public String generateOTP(GenerateOTPRequest generateOTPRequest) throws IOException, MessagingException {
        ...
        if (userOptional.isPresent()) {
            ...
            String emailBody1 = "" +
                    ...
                    "            </tbody>\n" +
                    "        </table>\n" +
                    "        <table class=\"es-header\" cellspacing=\"0\" cellpadding=\"0\" align=\"center\" style=\"mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;table-layout:fixed !important;width:100%;background-color:#000000;background-repeat:repeat;background-position:center top\">\n" +
                    "            <tbody>\n" +
                    "            <tr style=\"border-collapse:collapse\">\n" +
                    "                <td style=\"padding:0;Margin:0;background-color:#000000\" bgcolor=\"#000000\" align=\"center\">\n" +
                    "                    <table class=\"es-header-body\" cellspacing=\"0\" cellpadding=\"0\" align=\"center\" style=\"mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#000000;width:600px\">\n" +
                    "                        <tbody>\n" +
                    "                        <tr style=\"border-collapse:collapse\">\n" +
                    ...
                    "                                                <tbody>\n" +
                    "                                                <tr style=\"border-collapse:collapse\">\n" +
                    "                                                    <td align=\"center\" style=\"padding:0;Margin:0\"><p style=\"Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:36px;font-family:'comic sans ms', 'marker felt-thin', arial, sans-serif;line-height:54px;color:#FFFFFF\"><strong>Dokanee.com.bd</strong></p></td>\n" +
                    "                                                </tr>\n" +
                    "                                                </tbody>\n" +
                    "                                            </table></td>\n" +
                    "                                    </tr>\n" +
                    ...
                    "                                                <tbody>\n" +
                    "                                                <tr style=\"border-collapse:collapse\">\n" +
                    "                                                    <td align=\"center\" style=\"Margin:0;padding-bottom:5px;padding-left:30px;padding-right:30px;padding-top:35px\"><h1 style=\"Margin:0;line-height:58px;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;font-size:48px;font-style:normal;font-weight:normal;color:#111111\">Hello," + userOptional.get().getFirstName() + " " + userOptional.get().getLastName() + "&nbsp;<br></h1><h1 style=\"Margin:0;line-height:58px;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;font-size:48px;font-style:normal;font-weight:normal;color:#111111\">Trouble signing in?</h1></td>\n" +
                    "                                                </tr>\n" +
                    "                                                <tr style=\"border-collapse:collapse\">\n" +
                    ...
                    "                                                <tbody>\n" +
                    "                                                <tr style=\"border-collapse:collapse\">\n" +
                    "                                                    <td align=\"left\" style=\"padding:0;Margin:0\"><p style=\"Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:28px;font-family:'comic sans ms', 'marker felt-thin', arial, sans-serif;line-height:42px;color:#666666;text-align:center\"><strong>" + random_int + "<br><h2>Thanks, From Dokanee Team</h2></strong></p></td>\n" +
                    "                                                </tr>\n" +
                    "                                                </tbody>\n" +
                    "                                            </table></td>\n" +
                    "                                    </tr>\n" +
